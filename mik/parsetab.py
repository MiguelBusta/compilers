...
_lr_productions = [
  ...
  ('assignment -> VARIABLE EQUAL expression','assignment',3,'p_assignment_assign','translator-mik.py',66),
  ('assignment -> expression','assignment',1,'p_assignment_expression','translator-mik.py',73),
  ('expression -> term','expression',1,'p_expression_term','translator-mik.py',79),
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','translator-mik.py',85),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','translator-mik.py',91),
  ('term -> exponent','term',1,'p_term_exponent','translator-mik.py',97),
  ('term -> term TIMES exponent','term',3,'p_term_times','translator-mik.py',103),
  ('term -> term DIV exponent','term',3,'p_term_divides','translator-mik.py',109),
  ('exponent -> factor','exponent',1,'p_exponent_factor','translator-mik.py',115),
  ('exponent -> factor EXP factor','exponent',3,'p_exponent_exp','translator-mik.py',121),
  ('factor -> NUMBER','factor',1,'p_factor_num','translator-mik.py',127),
  ('factor -> VARIABLE','factor',1,'p_factor_variable','translator-mik.py',133),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','translator-mik.py',139),
]
